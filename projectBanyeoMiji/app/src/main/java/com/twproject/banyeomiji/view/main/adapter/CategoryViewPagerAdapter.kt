...
class CategoryViewPagerAdapter(
...
): RecyclerView.Adapter<CategoryViewPagerAdapter.ItemViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): CategoryViewPagerAdapter.ItemViewHolder {
        val adapterLayout = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_fragment_category_list, parent, false)
        return ItemViewHolder(adapterLayout)
    }

    override fun onBindViewHolder(holder: CategoryViewPagerAdapter.ItemViewHolder, position: Int) {
