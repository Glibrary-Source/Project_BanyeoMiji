...
class FragmentLocationList : Fragment() {
    ...
    override fun onCreateView(
        ...
        rcLocationListView.layoutAnimation =
            AnimationUtils.loadLayoutAnimation(requireContext(), R.anim.layout_animation_fall)
    ...
    private fun admobControl() {
        ...
        if( MyGlobals.instance!!.fullAdCount % MyGlobals.instance!!.adCount == 0 ) {
